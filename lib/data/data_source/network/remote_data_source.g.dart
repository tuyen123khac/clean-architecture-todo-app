...
class _RemoteDataSource implements RemoteDataSource {
  ...
  Future<PaginatedResWrapper<List<SalesMemberDto>>> getSalesTeam({
    ...
    final _options = _setStreamType<PaginatedResWrapper<List<SalesMemberDto>>>(
    ...
    late PaginatedResWrapper<List<SalesMemberDto>> _value;
    try {
      _value = PaginatedResWrapper<List<SalesMemberDto>>.fromJson(
        _result.data!,
        (json) => json is List<dynamic>
            ? json
                  .map<SalesMemberDto>(
                    (i) => SalesMemberDto.fromJson(i as Map<String, dynamic>),
                  )
                  .toList()
            : List.empty(),
      );
  ...
  @override
  Future<void> syncSellJewelry(SellJewelrySyncRequestDto request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
