...
class OffsetApp {
  ...
  static const o0_2 = Offset(0.0, -2.0);
  static const o00 = Offset(0.0, 0.0);
...
class DurationsApp {
  static const mil50 = Duration(milliseconds: 50);
  static const mil200 = Duration(milliseconds: 200);
  static const mil300 = Duration(milliseconds: 300);
  static const mil350 = Duration(milliseconds: 350);
  static const mil500 = Duration(milliseconds: 500);
  static const sec1 = Duration(seconds: 1);
  static const sec2 = Duration(seconds: 2);
  static const sec3 = Duration(seconds: 3);
  static const sec5 = Duration(seconds: 5);
  static const sec10 = Duration(seconds: 10);
  static const min27 = Duration(minutes: 27);
}
